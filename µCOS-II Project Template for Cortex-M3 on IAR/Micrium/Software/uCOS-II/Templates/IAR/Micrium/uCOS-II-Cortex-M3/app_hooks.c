...
* projects.  The code consists of hooks that will be invoked by uC/OS-II if the configuration constants 
* OS_CPU_HOOKS_EN and OS_APP_HOOKS_EN are both non-zero.
*
